...
La app consta de dos partes: la interfaz web (*front end*), hecha con [Lit](https://lit.dev/), y el servidor (*back end*), configurada con [PocketBase](https://pocketbase.io/).
